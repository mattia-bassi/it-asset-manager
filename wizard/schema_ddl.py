"""
DDL statements for IT Asset Manager database schema.
Copied verbatim from production mysqldump via 0001_initial_v274.py.
Tables organized by dependency level for ordered creation.
"""

# Revision to write into alembic_version after table creation
ALEMBIC_HEAD = "0001_initial_v274"

# Level 0 — No external foreign keys
LEVEL_0_TABLES = {
  ...
  KEY `idx_suppliers_is_active` (`is_active`)
    ...
    "location_types": """CREATE TABLE `location_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_location_types_is_active` (`is_active`)
    ...
    "asset_types": """CREATE TABLE `asset_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  ...
  CONSTRAINT `asset_types_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `asset_types` (`id`) ON DELETE CASCADE
    ...
    "document_templates": """CREATE TABLE `document_templates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `description` text DEFAULT NULL,
...
LEVEL_1_TABLES = {
  ...
  CONSTRAINT `fk_locations_site_id` FOREIGN KEY (`site_id`) REFERENCES `sites` (`id`)
    ...
    "inventory_skus": """CREATE TABLE `inventory_skus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LEVEL_3_TABLES = {
    "assignment_items": """CREATE TABLE `assignment_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
ALEMBIC_VERSION_TABLE = """CREATE TABLE `alembic_version` (
  `version_num` varchar(32) NOT NULL,
  PRIMARY KEY (`version_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;"""

# Drop order (reverse of creation) for cleanup
DROP_ORDER = [
    "assignment_items", "audit_logs", "documents",
    "assignments", "assets", "sims", "badges", "users",
    "people", "locations", "inventory_skus",
    "sites", "asset_types", "location_types", "document_templates", "suppliers",
    "alembic_version",
]
